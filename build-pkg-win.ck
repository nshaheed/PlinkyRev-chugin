...
ver.generateVersion("./", "PlinkyRev_win", "https://ccrma.stanford.edu/~nshaheed/" + path);
...
chout <= "scp PlinkyRev_win.zip nshaheed@ccrma-gate.stanford.edu:~/Library/Web/" <= path <= IO.newline();

// Generate a version definition json file, stores this in "chumpinate/<VerNo>/PlinkyRev_win.json"
ver.generateVersionDefinition("PlinkyRev_win", "./" );