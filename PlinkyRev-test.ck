...
//    (the bulid process should yield a PlinkyRev.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:PlinkyRev.chug PlinkyRev-test.ck`
//
...
//    `chuck --chugin:PlinkyRev.chug PlinkyRev-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a PlinkyRev
PlinkyRev obj;
